...
#
#     # خود جدول لاگ ثبت نشود
#     if sender == SystemLog:
#         return
#
#     # اپ‌های سیستمی ثبت نشوند
...
#
#     # -----------------------------
#     # حذف فقط قدیمی‌ترین لاگ منقضی‌شده
#     # (برای تست: 30 ثانیه)
#     # -----------------------------
...
#         app_name=sender._meta.app_config.verbose_name,
...
#         user=user,
#         ip_address=ip,
#         old_data=serialize_instance(instance) if action == "delete" else None,
#         new_data=serialize_instance(instance) if action != "delete" else None,
#     )
#
#
# @receiver(post_save)
